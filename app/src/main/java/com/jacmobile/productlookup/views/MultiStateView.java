package com.jacmobile.productlookup.views;
...
/**
 * View that contains 4 different states: Content, Error, Empty, and Loading.<br> Each state has
 * their own separate layout which can be shown/hidden by setting the {@link
 * MultiStateView.ViewState} accordingly Every MultiStateView <b><i>MUST</i></b> contain a content
 * view. The content view is obtained from whatever is inside of the tags of the view via its XML
 * declaration
 */
public class MultiStateView extends FrameLayout
{
    ...
    /**
     * Returns the {@link View} associated with the {MultiStateView.ViewState}
     *
     * @param state The {MultiStateView.ViewState} with to return the view for
     * @return The {@link View} associated with the {MultiStateView.ViewState}, null if no view is
     * present
     */
    @Nullable
     ...
     *
     * @param state The {MultiStateView.ViewState} to set {@link MultiStateView} to
     */
    ...
    /**
     * Shows the {@link View} based on the {MultiStateView.ViewState}
     */
    ...
    /**
     * Sets the {@link View} for the given {MultiStateView.ViewState}
     *
     * @param view  The {@link View} to use
     * @param state The {MultiStateView.ViewState} to set
     */
